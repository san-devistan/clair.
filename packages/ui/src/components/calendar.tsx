...
function CalendarRoot({
  ...
  rootRef,
  ...rootProps
}: Parameters<NonNullable<CalendarComponents["Root"]>>[0]) {
  return (
    <div
      data-slot="calendar"
      ref={rootRef}
...
function CalendarChevron({
  ...
  orientation,
  ...chevronProps
}: Parameters<NonNullable<CalendarComponents["Chevron"]>>[0]) {
  if (orientation === "left") {
    return (
      <ChevronLeftIcon
...
function CalendarWeekNumber({
  children,
  ...weekNumberProps
}: Parameters<NonNullable<CalendarComponents["WeekNumber"]>>[0]) {
  return (
    <td {...weekNumberProps}>
